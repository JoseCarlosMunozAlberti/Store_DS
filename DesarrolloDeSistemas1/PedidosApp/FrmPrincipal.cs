...
namespace PedidosApp
{
    public partial class FrmPrincipal : Form
    {
        ...
        private struct RGBcolors
        {
            ...
            public static Color color7 = Color.FromArgb(24, 162, 241);
            public static Color color8 = Color.FromArgb(25, 163, 231);
            public static Color color9 = Color.FromArgb(26, 164, 221);
        }
        //Metodos
        private void ActivateButton(object senderBtn, Color color)
        {
            if (senderBtn != null) 
            {
                ...
                //Actualizar el icono del formulario hijo actual
        ...
        //El siguiente codigo es para arrastrar el formulario e importar libreria
